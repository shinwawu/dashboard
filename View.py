...
class InterfaceDashboard:
    ...
    def atualizacao_interface(self):
        ...
        for i in range(0, 101, 10):
            ...
            if tempo_seg % 25 == 0:
                self.GraficoCPU.create_text(x, altura - 5, text=f"{tempo_seg}s", anchor="n", fill="white", font=("Arial", 8))
        ...
        for i in range(0, 101, 10):
            ...
            if tempo_seg % 25 == 0:
                self.GraficoMemoria.create_text(x, altura - 5, text=f"{tempo_seg}s", anchor="n", fill="white", font=("Arial", 8))
