...
class InterfaceDashboard:
    ...
    def interface_aba_geral(self):
        ...
        self.GraficoBarraMemoria = tk.Canvas(frame_memoria, width=100, height=200, bg="black")
    ...
    def atualizacao_interface(self):
        ...
        for i in range(0, 101, 10):
            ...
            if tempo_seg % 25 == 0:
                self.GraficoMemoria.create_text(x, altura + margem_y + 10, text=f"{tempo_seg}s", anchor="n", fill="white", font=("Arial", 8))

        # Linhas do gráfico da Memória
